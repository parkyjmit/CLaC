...
https://github.com/M3RG-IITD/MatSciBERT/tree/main
'''
import os
...
parser.add_argument('--model_name', choices=['scibert', 'matscibert', 'bert', 'clamp'], required=True, type=str)
...
if args.model_name == 'scibert':
    ...
    to_normalize = False
elif args.model_name == "clamp":
    model_name = "pretrained_model/clamp_merged_painn_dlr"
    to_normalize = False
else:
...
dataset_dir = 'jsons/glass_non_glass'
