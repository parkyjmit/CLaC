...
from data.utils import pubchem_request, search_mat_in_paper_return_paragraphs
...
def main(args):
    if args['find_paragraphs']:
        ...
        for i in range(10):
            ...
            # Save as parquet
            if args['search_only_in_battery_papers']:
                parallel_result.to_parquet(f'liquid_electrolytes_battery_papers.parquet')
                break
            else:
                parallel_result.to_parquet(f'liquid_electrolytes_materials_papers{i}.parquet')
